...
public class Openchatroom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_openchatroom);
        getSupportActionBar().setTitle("                         오픈 채팅방");
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                imgRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(Openchatroom.this, "프로필 저장 완료", Toast.LENGTH_SHORT).show();

                        //1. Firebase Database에 nickName2, profileUrl을 저장
                        ...
                        editor.commit();
                        //저장이 완료되었으니 ChatActivity2로 전환
                        Intent intent=new Intent(Openchatroom.this, ChatActivity.class);
