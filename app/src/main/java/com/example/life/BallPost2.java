...
public class BallPost2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!comment.isEmpty()) {
                    ...
                    Toast.makeText(BallPost2.this, "댓글이 작성되었습니다.", Toast.LENGTH_SHORT).show();
                }
                editText.setText("");
            }
        });
        ...
        mStore.collection(FirebaseID.ballpost).document(id)
                .get()
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            if (task.getResult().exists()) {
                                ...
                                Toast.makeText(BallPost2.this, "삭제된 문서입니다.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
        ...
        buttonFavorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BallPost2.this, LikeBoard.class);
                intent.putExtra("title", mTitleText.getText().toString());
                intent.putExtra("contents", mContentsText.getText().toString());
                Toast.makeText(BallPost2.this, "게시글이 찜 되었습니다.", Toast.LENGTH_SHORT).show();
        ...
        builder.setMessage("해당 댓글을 삭제하시겠습니까?")
                .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        deleteComment();
                        Toast.makeText(BallPost2.this, "댓글이 삭제되었습니다.", Toast.LENGTH_SHORT).show();
                    }
                })
