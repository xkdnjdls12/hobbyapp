...
public class BicyclePost2 extends AppCompatActivity {
    ...
    EditText editText;
    TextView textView;
    List<String> commentsListB; // 댓글 목록을 저장하는 리스트
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ball_post2);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!comment.isEmpty()) {
                    commentsListB.add(comment);
                    updateCommentsTextView();
                    Toast.makeText(BicyclePost2.this, "댓글이 작성되었습니다.", Toast.LENGTH_SHORT).show();
                }
                editText.setText("");
            }
        });
        ...
        mStore.collection(FirebaseID.bicyclepost).document(id)
                .get()
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            if (task.getResult().exists()) {
                                ...
                                Toast.makeText(BicyclePost2.this, "삭제된 문서입니다.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });

        commentsListB = new ArrayList<>();
        ...
        buttonFavorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BicyclePost2.this, LikeBoard.class);
                intent.putExtra("title", mTitleText.getText().toString());
                intent.putExtra("contents", mContentsText.getText().toString());
                Toast.makeText(BicyclePost2.this, "게시글이 찜 되었습니다.", Toast.LENGTH_SHORT).show();
    ...
    private void updateCommentsTextView() {
        ...
        for (String comment : commentsListB) {
    ...
    private void saveState() {
        ...
        editor.putString("commentsListB", commentsListToString());
        editor.commit();
    }

    private void restoreState() {
        SharedPreferences pref = getSharedPreferences("pref", Activity.MODE_PRIVATE);
        if ((pref != null) && (pref.contains("comment")) && (pref.contains("commentsListB"))) {
            String comment = pref.getString("comment", "");
            String commentsListString = pref.getString("commentsListB", "");
            editText.setText(comment);
            commentsListB = stringToCommentsList(commentsListString);
            updateCommentsTextView();
        }
    }
        ...
        builder.setMessage("해당 댓글을 삭제하시겠습니까?")
                .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        deleteComment();
                        Toast.makeText(BicyclePost2.this, "댓글이 삭제되었습니다.", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    private void deleteComment() {
        String clickedComment = commentsListB.get(commentsListB.size() - 1);
        commentsListB.remove(clickedComment);
        updateCommentsTextView();
    }
