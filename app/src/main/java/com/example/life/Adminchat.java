...
public class Adminchat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //폰에 저장되어 있는 프로필 읽어오기
        loadData();
        if(G2.nickName2!=null){
            etName.setText(G2.nickName2);
            Picasso.get().load(G2.porfileUrl2).into(ivProfile);
    ...
    void saveData(){
        ...
        G2.nickName2= etName.getText().toString();
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                imgRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        G2.porfileUrl2= uri.toString();
                        Toast.makeText(Adminchat.this, "프로필 저장 완료", Toast.LENGTH_SHORT).show();
                        ...
                        profileRef.child(G2.nickName2).setValue(G2.porfileUrl2);

                        //2. 내 phone에 nickName, profileUrl을 저장
                        SharedPreferences preferences= getSharedPreferences("account",MODE_PRIVATE);
                        SharedPreferences.Editor editor=preferences.edit();

                        editor.putString("nickName2",G2.nickName2);
                        editor.putString("profileUrl2", G2.porfileUrl2);

                        editor.commit();
                        //저장이 완료되었으니 ChatActivity로 전환
                        Intent intent=new Intent(Adminchat.this, ChatActivity2.class);
                        startActivity(intent);
                        finish();
    ...
    void loadData(){
        SharedPreferences preferences=getSharedPreferences("account",MODE_PRIVATE);
        G2.nickName2=preferences.getString("nickName2", null);
        G2.porfileUrl2=preferences.getString("profileUrl2", null);
