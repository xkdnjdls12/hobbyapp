...
public class FishingPost2 extends AppCompatActivity {
    ...
    EditText editText;
    TextView textView;
    List<String> commentsListf; // 댓글 목록을 저장하는 리스트
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fishing_post2);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!comment.isEmpty()) {
                    commentsListf.add(comment);
                    updateCommentsTextView();
                    Toast.makeText(FishingPost2.this, "댓글이 작성되었습니다.", Toast.LENGTH_SHORT).show();
                }
                editText.setText("");
            }
        });
        ...
        mStore.collection(FirebaseID.fishingpost).document(id)
                .get()
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            if (task.getResult().exists()) {
                                ...
                                Toast.makeText(FishingPost2.this, "삭제된 문서입니다.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });

        commentsListf = new ArrayList<>();
        ...
        buttonFavorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FishingPost2.this, LikeBoard.class);
                intent.putExtra("title", mTitleText.getText().toString());
                intent.putExtra("contents", mContentsText.getText().toString());
                Toast.makeText(FishingPost2.this, "게시글이 찜 되었습니다.", Toast.LENGTH_SHORT).show();
    ...
    private void updateCommentsTextView() {
        ...
        for (String comment : commentsListf) {
    ...
    private void saveState() {
        ...
        editor.putString("commentsListf", commentsListToString());
        editor.commit();
    }

    private void restoreState() {
        SharedPreferences pref = getSharedPreferences("pref", Activity.MODE_PRIVATE);
        if ((pref != null) && (pref.contains("comment")) && (pref.contains("commentsListf"))) {
            String comment = pref.getString("comment", "");
            String commentsListString = pref.getString("commentsListf", "");
            editText.setText(comment);
            commentsListf = stringToCommentsList(commentsListString);
            updateCommentsTextView();
        }
    }
        ...
        builder.setMessage("해당 댓글을 삭제하시겠습니까?")
                .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        deleteComment();
                        Toast.makeText(FishingPost2.this, "댓글이 삭제되었습니다.", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    private void deleteComment() {
        String clickedComment = commentsListf.get(commentsListf.size() - 1);
        commentsListf.remove(clickedComment);
        updateCommentsTextView();
    }
