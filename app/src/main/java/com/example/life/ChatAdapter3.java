...
public class ChatAdapter3 extends BaseAdapter {

    ArrayList<MessageItem2> messageItems;
    LayoutInflater layoutInflater;

    public ChatAdapter3(ArrayList<MessageItem2> messageItems2, LayoutInflater layoutInflater) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        //메세지가 내 메세지인지??
        if(item.getName().equals(G3.nickName3)){
