...
public class ChatActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(G3.nickName3);

        et=findViewById(R.id.et);
        listView=findViewById(R.id.listview);
        adapter=new ChatAdapter3(messageItems,getLayoutInflater());
    ...
    public void clickSend(View view) {
        ...
        String nickName= G3.nickName3;
        String message= et.getText().toString();
        String pofileUrl= G3.porfileUrl3;
