...
public class CampingPost2 extends AppCompatActivity {
    ...
    EditText editText;
    TextView textView;
    List<String> commentsListc; // 댓글 목록을 저장하는 리스트
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camping_post2);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!comment.isEmpty()) {
                    commentsListc.add(comment);
                    updateCommentsTextView();
                    Toast.makeText(CampingPost2.this, "댓글이 작성되었습니다.", Toast.LENGTH_SHORT).show();
                }
                editText.setText("");
            }
        });
        ...
        mStore.collection(FirebaseID.campingpost).document(id)
                .get()
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            if (task.getResult().exists()) {
                                ...
                                Toast.makeText(CampingPost2.this, "삭제된 문서입니다.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });

        commentsListc = new ArrayList<>();
        ...
        buttonFavorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CampingPost2.this, LikeBoard.class);
                intent.putExtra("title", mTitleText.getText().toString());
                intent.putExtra("contents", mContentsText.getText().toString());
                Toast.makeText(CampingPost2.this, "게시글이 찜 되었습니다.", Toast.LENGTH_SHORT).show();
    ...
    private void updateCommentsTextView() {
        ...
        for (String comment : commentsListc) {
    ...
    private void saveState() {
        ...
        editor.putString("commentsListc", commentsListToString());
        editor.commit();
    }

    private void restoreState() {
        SharedPreferences pref = getSharedPreferences("pref", Activity.MODE_PRIVATE);
        if ((pref != null) && (pref.contains("comment")) && (pref.contains("commentsListc"))) {
            String comment = pref.getString("comment", "");
            String commentsListString = pref.getString("commentsListc", "");
            editText.setText(comment);
            commentsListc = stringToCommentsList(commentsListString);
            updateCommentsTextView();
        }
    }
        ...
        builder.setMessage("해당 댓글을 삭제하시겠습니까?")
                .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        deleteComment();
                        Toast.makeText(CampingPost2.this, "댓글이 삭제되었습니다.", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    private void deleteComment() {
        String clickedComment = commentsListc.get(commentsListc.size() - 1);
        commentsListc.remove(clickedComment);
        updateCommentsTextView();
    }
